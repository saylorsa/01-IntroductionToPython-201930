...
sterling=rg.SimpleTurtle('turtle')
sterling.pen=rg.Pen('blue',1)

sterling.left(90)
sterling.forward(200)
sterling.pen_up()
sterling.go_to(rg.Point(100,-40))
sterling.pen_down()

sterling.pen=rg.Pen('green',10)
sterling.backward(150)
